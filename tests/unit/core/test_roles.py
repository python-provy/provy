...
class RoleTest(ProvyTestCase):
    ...
    def creates_a_new_file_when_remote_doesnt_exist_during_update(self):
        ...
        with self.mock_role_method('write_to_temp_file'), self.mock_role_method('put_file'), self.mock_role_method('remote_exists'):
    ...
    def updates_file_when_remote_exists_but_is_different(self):
        ...
        with self.mock_role_method('write_to_temp_file'), self.mock_role_method('put_file'), self.mock_role_method('remote_exists'), self.mock_role_method('md5_local'), self.mock_role_method('md5_remote'):
