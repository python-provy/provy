...
class BasePostgreSQLRole(Role):
    ...
    * Administrative database is named postgres
    ...
    def get_password(self):
        for ii in range(3):
            p = getpass.getpass(
                ...
                .format(user = username, host = self.context.get('host', "unknown")))
    ...
    def create_user(self, username, password = False, ask_password = True, is_superuser=False, can_create_databases=False, can_create_roles=False):
        """
    ...
    def ensure_user(self, username, password = None, ask_password=True, is_superuser=False, can_create_databases=False, can_create_roles=False):
        ...
        if not self.user_exists(username):
            ...
            return self.create_user(username, password, ask_password, is_superuser, can_create_databases, can_create_roles)
        return True
